...
and included in the main report. In appendix A, further visualizations
of missing values, histograms and correlation plots are included.

\hypertarget{box-plot}{%
\subsubsection{3.1 Box Plot}\label{box-plot}}
