...
```{r correlation, fig.cap= "Correlation plot displaying the correlation between numeric variables", fig.pos="p", fig.label='fig:appendix-correlation',echo=FALSE, message=FALSE, warning=FALSE, fig.width=3}
