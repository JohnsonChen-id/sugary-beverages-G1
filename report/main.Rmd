...
beverage_sales %>% filter(DofW %in% c(6,7)) %>% boxplots_by_category(responses = c("ZeroCal", "Sugary"), category = "Intervention")
...
The following plot investigates the correlation structure between numeric variables within the dataset. In this plot, the size, color of the circles and number represent the strength of the correlation coefficients between the variables.
