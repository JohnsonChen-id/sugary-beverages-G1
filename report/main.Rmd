...
beverage_sales <- beverage_sales %>% mutate(Site = recode(Site, 
                                                          chop = "A",
                                                          HF = "B",
                                                          NS = "C"))
